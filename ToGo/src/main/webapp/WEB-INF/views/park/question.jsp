...
<body>
    ...
    <form action="/question" method="post">
        ...
        <fieldset data-question-id="A" style="display: none;">
            <legend>Result A</legend>
            <p>당신은 여행의 철학을 가지고 있습니다.</p>
            <button type="submit">Restart</button>
        </fieldset>
        <fieldset data-question-id="B" style="display: none;">
            <legend>Result B</legend>
            <p>당신은 음식과 문화를 즐기는 여행자입니다.</p>
            <button type="submit">Restart</button>
        </fieldset>
        <fieldset data-question-id="C" style="display: none;">
            <legend>Result C</legend>
            <p>당신은 자유로운 영혼의 여행자입니다.</p>
            <button type="submit">Restart</button>
        </fieldset>
